        ...
        <div className="bg-stone-900 w-full flex flex-col justify-center items-center" style={{minHeight: "calc(100dvh - 123px)"}}>
          <div className="max-w-6xl flex flex-col md:flex-row items-center gap-10 w-full text-zinc-100">
            <div className="md:w-1/2 flex flex-col gap-4">
              <div>
                <Heading>Sell your home with confidence</Heading>
              ...
              <form className="flex flex-col gap-4">
                ...
                <Button>Sell your home</Button>
              </form>
            </div>
            <div className="md:w-1/2">
              <img className="rounded-2xl" src="https://images.unsplash.com/photo-1577415124269-fc1140a69e91?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=928&q=80" />
            </div>
